...
if length(value_listbox2)==1 && length(value_listbox3)==1
    setappdata(app.GUI.main_GUI,'XAxisVarName',contents_listbox3{value_listbox3});
    setappdata(app.GUI.main_GUI,'XAxisSubsysName',contents_listbox2{value_listbox2});
    set(app.GUI.XAxisVarName,'String',[contents_listbox2{value_listbox2} '.' contents_listbox3{value_listbox3}]);
else
...
% Get data
app.GUI = guidata(hObject);
Dir = getappdata(app.GUI.main_GUI,'FileImportDir');
DatasetsStruct = getappdata(app.GUI.main_GUI,'DatasetsStruct');
UserDefExt = getappdata(app.GUI.main_GUI,'UserDefExt');
