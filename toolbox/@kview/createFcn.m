...
h = uibutton(...
    'Parent',app.GUI.HButtonBox1,...
    'ButtonPushedFcn',@(~,~) app.importFromMatfile(),...
...
set(app.GUI.VBox2,'MinimumHeights',[32 20 20 32],'Heights',[32 20 20 32]);
...
h = uimenu(...
    ...
    'Label','Add to current plot (on second Y axis)',...
...
h = uimenu(...
    ...
    'Label','Table and Timetable (default)',...
...
if doPlot
    ...
    app.plot(app.GUI.TargetFigure.Value);
