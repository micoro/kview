...
h = uilistbox(...
    ...
    'ValueChangedFcn',@(hObject,~) Listbox_Callback(hObject,[],app,false),...
    'DoubleClickedFcn',@(hObject,~) Listbox_Callback(hObject,[],app,true),...
    'MultiSelect','on',...
    'Items',{},...
    'Value',{},...
    'Tag','listbox1');
...
function Listbox_Callback(hObject, ~, app,doPlot)
