...
%% PLOT 
linePropertyCellArray = namedargs2cell(app.kvLineProperty);
for iDataset = dataset
    if plotXData
        plot(axes_handle, ...
            iDataset.Table(:,[app.selectedVariable; app.XAxis]), ...
            app.XAxis, ...
            app.selectedVariable, ...
            linePropertyCellArray{:});
    else  
        plot(axes_handle, ...
            iDataset.Table(:,app.selectedVariable), ...
            app.selectedVariable, ...
            linePropertyCellArray{:});
    end
end
